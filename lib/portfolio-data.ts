...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    longDescription:
      "Nonprofits often get underpowered websites that can't grow with them. This one was built to last — with a real database, production-grade error handling, and a content structure that the team can manage without a developer.",
    challenge:
  ...
  },
  {
    ...
    features: [
      ...
      "Purposeful Framer Motion animations — no gratuitous effects",
  ...
  },
  {
    ...
    longDescription:
      "DEX interfaces are notoriously confusing. This one focuses on making the swap flow clear — showing the user exactly what they're getting, what it costs, and what happens next.",
  ...
  },
  {
    ...
    longDescription:
      "NFT marketplaces live or die on trust. This one is designed to make every transaction feel safe — with clear ownership states, transparent pricing, and a checkout flow that doesn't surprise the user.",
