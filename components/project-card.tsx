      ...
      <Card className="relative overflow-hidden flex flex-col h-full border-0 bg-white dark:bg-gray-900 shadow-xl group-hover:shadow-2xl transition-all duration-500 rounded-2xl mx-auto max-w-sm sm:max-w-none">
        <div className="relative h-48 sm:h-56 md:h-64 w-full overflow-hidden">
          ...
          >
            <Button
              size="icon"
              variant="secondary"
              className="h-10 w-10 bg-white/20 backdrop-blur-md hover:bg-white/30 text-white border border-white/20 shadow-lg"
        ...
        <CardContent className="flex-1 p-6 space-y-5">
          <div className="space-y-3">
            <motion.h3
              className="text-xl font-bold text-gray-900 dark:text-gray-100 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-all duration-300"
            ...
            <div className="flex flex-wrap gap-2">
              {tags.map((tag, index) => (
                ...
                >
                  ...
                  >
                    <span className="mr-1.5 text-sm">{techIcons[tag] || "🔧"}</span>
                    {tag}
                  </Badge>
                </motion.div>
              ))}
            ...
            <motion.div className="flex-1" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              ...
              >
                <Link href={githubUrl} target="_blank" rel="noopener noreferrer">
                  <SiGithub className="mr-2 h-4 w-4 group-hover:rotate-12 transition-transform duration-200" />
                  Source Code
                </Link>
              </Button>
            </motion.div>
            <motion.div className="flex-1" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              ...
              >
                <Link href={liveUrl} target="_blank" rel="noopener noreferrer">
                  <ExternalLink className="mr-2 h-4 w-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200" />
                  Live Demo
                </Link>
              </Button>
            </motion.div>
